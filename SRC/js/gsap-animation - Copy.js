...
document.addEventListener("DOMContentLoaded", () => {
  ...
  mm.add("(min-width: 577px)", () => {
    ...
    gsap.set(".darr-scroll", { y: 100 });

    gsap.set(".gvcom__logo", { y: -150 });
    gsap.set(".gvcom__content", { x: 150 });
    ...
    const TL_Commingsoon = gsap.timeline({
      scrollTrigger: {
    ...
    TL_Commingsoon.to({}, { duration: 1 });

    TL_Commingsoon.to(".darr-scroll", {
      autoAlpha: 1,
      y: 0,
      duration: 0.8,
      ease: "power2.out"
    ...
    TL_Gvcom.to({}, { duration: 1 });

    TL_Gvcom.to(".gvcom__logo", {
      autoAlpha: 1,
      y: 0,
      duration: 0.8,
      ease: "bounce.out"
  ...
  function createScrollCarousel() {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        pin: true,
        pinSpacing: true,
        // The carousel precedes gvcomingsoon, so its spacer must be calculated
        // before the following section's ScrollTrigger.
        refreshPriority: 1,
        anticipatePin: 1
      }
    });
